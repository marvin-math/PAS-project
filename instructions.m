function instructions(env, window, task)
        screen1 = ['Thank you for participating in our study on perceptual awareness! ' ...
            ...
            '\n\nAfter this you will be asked to indicate the clarity of the experience on the Perceptual Awareness Scale.'];
                    
        screen2 = ['You can provide a rating from 1 to 4 on this scale.' ...
        ...
        screen4 = ['Please keep the following instructions in mind:' ...
            ...
            '\n\n4)   Some conditions will seem very hard, but don''t be discouraged!' ...
        ...
        Screen('DrawTexture', window, PASInstructionTex, [0 0 1150 700]);
        Screen('Flip', window);
        [~, ~, ~] = KbStrokeWait;
        % Screen3
        Screen('TextSize', window, 30);
